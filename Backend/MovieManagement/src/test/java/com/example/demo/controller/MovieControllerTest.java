...
class MovieControllerTest {
    ...
    void testAddMovie() throws Exception {
        ...
        actualPerformResult.andExpect(MockMvcResultMatchers.status().isCreated())
                ...
                .andExpect(MockMvcResultMatchers.content()
                        .string(
                                "{\"movieId\":1,\"movieName\":\"Movie Name\",\"theatreCapacity\":1,\"theatreDetails\":[],\"availableSeats\":1}"));
    }
    ...
    /**
     * Method under test: {@link MovieController#getMovie()}
     */
    @Test
    void testGetMovie() throws Exception {
        ...
        MockMvcBuilders.standaloneSetup(movieController)
                ...
                .andExpect(MockMvcResultMatchers.content()
                        .string(
                                "{\"headers\":{},\"body\":{\"Status Code\":200,\"Custom Message\":\"Successfully fetched movielist\",\"Payload\":"
